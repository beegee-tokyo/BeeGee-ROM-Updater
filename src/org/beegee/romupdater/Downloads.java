...
public class Downloads extends ROMSuperActivity {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				confirm.setCancelable(true)
						...
						.setNeutralButton(getString(R.string.delete_zip), new DialogInterface.OnClickListener() {
									@Override
									public void onClick(DialogInterface dialog,	int which) {
										// delete the zip file, then recreate
										// the list
	...
	private void createDownloadsList() {
		...
		if (!dir.isDirectory() || dir.list().length == 0) {
			...
			info.setMessage(getString(R.string.info_no_downloads)).setCancelable(false).setPositiveButton(getString(R.string.OK), new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog,	int which) {
									dialog.dismiss();
									finish();
