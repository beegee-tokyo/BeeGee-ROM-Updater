...
public class Restore extends ROMSuperActivity {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				confirm.setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,	int which) {
								...
								// something like
								// [/sdcard/][my_folder/of_backups/][backup_folder]
				...
				// cancel the restore
				confirm.setNegativeButton(getString(R.string.no),
	...
	private void createRestoreList() {
		...
		if (dir.isDirectory()) {
			...
			dirNotExists
					.setMessage(getString(R.string.error_backup_folder_doesnt_exist));
